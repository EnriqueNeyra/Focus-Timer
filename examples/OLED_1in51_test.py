...
try:
    ...
    font1 = ImageFont.truetype(os.path.join('../lib/waveshare_OLED', 'Font.ttc'), 18)
    font2 = ImageFont.truetype(os.path.join('../lib/waveshare_OLED', 'Font.ttc'), 24)
